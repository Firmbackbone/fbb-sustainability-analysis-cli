...
def test_nltk():
    print("Testing NLTK...")
    try:
        # Set NLTK data path to our local directory
        nltk.data.path = ['./models/nltk']
...
def test_spacy():
    ...
    try:
        ...
        try:
            ...
            print("Please download the Dutch model using: python -m spacy download nl_core_news_sm")
            return False
